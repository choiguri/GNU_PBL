...
void AGnuMonsterAIController::UpdateTarget()
{
    ...
    if (NewTarget)
    {
        ...
        if (!bActivateHealthBar)
        {
            ...
            ActivateMonsterHealthBar();         // 몬스터 Health 위젯 최초 한번 활성화
        }
    }
    else
    {
